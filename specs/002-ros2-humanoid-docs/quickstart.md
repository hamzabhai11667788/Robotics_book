# Quickstart: ROS 2 for Humanoid Robotics Documentation

## Overview
This quickstart guide will help you set up and run the ROS 2 for Humanoid Robotics documentation locally on your machine.
...
### 4. Navigate to the ROS 2 Content
Once the server is running, you can access the ROS 2 for Humanoid Robotics documentation at:
`http://localhost:3000/docs/ros2-humanoid/intro-to-ros2`

## Adding New Content
To add new documentation content:

1. Create a new `.md` file in the `docs/ros2-humanoid/` directory
